...
const urls = WIDGET_URLS.rockville;
const COURTS = 8;

export const metadata: Metadata = {
  title: "Dill Dinkers Rockville — Indoor Pickleball Courts, Leagues & Coaching",
  description:
    "Indoor pickleball at Dill Dinkers Rockville. 8 courts, leagues, open play, coached sessions, coaching, and youth programs. 40C Southlawn Court, Rockville, MD 20850.",
  keywords: [
    "pickleball Rockville MD",
    "indoor pickleball Rockville",
    "Dill Dinkers Rockville",
    "pickleball courts Rockville",
    "pickleball lessons Rockville MD",
...
const MAPS_URL =
  "https://www.google.com/maps/search/?api=1&query=Dill+Dinkers+Rockville+40C+Southlawn+Court+Rockville+MD";
